...
const EventSelection = () => {
  ...
  return (
    <PageLayout
      title="Select Event for Entrance Registration"
      description="Choose an event to record entrance fees and manage entrance records"
    >
      <DataTable
        data={events}
        columns={columns}
        ...
        loading={isLoading}
        emptyMessage="No events available for entrance registration"
        className="shadow-sm"
      />
    </PageLayout>
  )
