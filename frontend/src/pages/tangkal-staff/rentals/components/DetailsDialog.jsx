        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
             ...
             <div>
               ...
               <div className="mt-1">
                 <span className={`inline-flex px-3 py-1 text-sm font-medium rounded-full ${
                   rental.paymentStatus === 'paid' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                 }`}>
             ...
             <div>
               ...
               <div className="mt-1">
                 <span className={`inline-flex px-3 py-1 text-sm font-medium rounded-full ${
                   rental.rentalStatus === 'returned' ? 'bg-gray-100 text-gray-800' : 'bg-blue-100 text-blue-800'
                 }`}>
